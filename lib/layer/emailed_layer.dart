...
class EmailedLayer {
  final api = GetIt.I.get<NetworkApi>().emailedApi;
  ...
  Future<Result<AllDataModel>> getEmailedArticles({int period = 1}) async {
    try {
      dataModel = await api.getEmailedArticles(period: period);
