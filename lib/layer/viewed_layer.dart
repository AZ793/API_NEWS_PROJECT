...
class ViewedLayer {
  final api = GetIt.I.get<NetworkApi>().viewedApi;
  ...
  Future<Result<AllDataModel>> getViewedArticles({int period = 1}) async {
    try {
      dataModel = await api.getViewedArticle(period: period);
